...
>
> [Open the map](https://warheatmap.app) · [source](https://github.com/indicaindependent/warheatmap)
...
> server owner can audit the reasoning instead of trusting a black box.
